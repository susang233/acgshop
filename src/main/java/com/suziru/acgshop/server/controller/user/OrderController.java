...
import com.suziru.acgshop.common.properties.WeixinpayProperties;
import com.suziru.acgshop.common.result.Result;
import com.suziru.acgshop.common.util.*;
...
public class OrderController {
    ...
    public Result preparePay(@RequestBody String orderNo, @RequestHeader(value="token") String token)throws Exception{
        ...
        if(resultMap.get("result_code").equals("SUCCESS")){
            ...
            return Result.error("系统报错，请联系管理员");
        }
